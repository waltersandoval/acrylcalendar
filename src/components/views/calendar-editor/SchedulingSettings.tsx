  ...
  return (
    <div className="srf-panel pb-10 rounded-b-2xl">
      ...
      <div className="p-8 space-y-10 srf-panel max-w-5xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between text-sm font-semibold ink-3 mb-4 gap-4 srf-sunken p-4 rounded-2xl border hairline">
        ...
        <div className="border hairline rounded-xl overflow-hidden mt-10 srf-panel max-w-3xl shadow-sm">
          <div 
