...
Este archivo lo lee automáticamente Codex en cada sesión futura en este
...
- Copiar este archivo a la raíz de cualquier proyecto nuevo, o pegar su
  contenido en `~/.Codex/AGENTS.md` en tu computadora para que se aplique
  automáticamente en todas las sesiones de Codex, en cualquier repo.
- Al arrancar un proyecto nuevo con IA, pedir explícitamente desde el
  principio: *"seguí las reglas de seguridad de AGENTS.md mientras
