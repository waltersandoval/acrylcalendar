  ...
  if (isMobileApp) {
    return (
      <div className="flex flex-col gap-3">
        {/* Segmented control */}
        <div className="srf-panel rounded-2xl border hairline p-1 flex items-center shadow-sm">
          {segments.map((seg) => {
        ...
        <div className="grid grid-cols-2 gap-3">
          {/* Calendarios */}
          <div className="srf-panel rounded-2xl border hairline shadow-sm p-4">
            <div className="w-9 h-9 rounded-xl srf-sunken flex items-center justify-center mb-3">
              <CalendarDays className="w-5 h-5 ink-1" />
            </div>
            <p className="text-[28px] font-extrabold ink-1 leading-none">{calendarsCount}</p>
            <p className="text-[11px] font-semibold ink-3 mt-1 uppercase tracking-wider">Calendarios</p>
          </div>
          ...
          <div className="srf-panel rounded-2xl border hairline shadow-sm p-4">
            ...
            <p className="text-[28px] font-extrabold ink-1 leading-none">{stats.activeAppointments}</p>
            <p className="text-[11px] font-semibold ink-3 mt-1 uppercase tracking-wider">Citas activas</p>
          </div>
        </div>

        {/* Ingresos — full width */}
        <div className="srf-panel rounded-2xl border hairline shadow-sm p-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 rounded-xl bg-amber-50 flex items-center justify-center">
              <DollarSign className="w-5 h-5 text-amber-600" />
            </div>
            <div>
              <p className="text-[11px] font-semibold ink-3 uppercase tracking-wider">Ingresos Est.</p>
              <p className="text-[26px] font-extrabold ink-1 leading-tight">${stats.estimatedRevenue}</p>
            </div>
          </div>
  ...
  return (
    <div className="flex flex-col space-y-5">
      <div className="flex justify-between items-end">
        <h2 className="text-[22px] font-semibold ink-1 tracking-tight">Actividad Reciente</h2>
        <div className="flex space-x-1 border-b hairline pb-2">
              ...
              <button
                ...
                className={`px-3.5 py-1.5 text-[11px] font-semibold uppercase tracking-wider rounded-[8px] transition-all duration-200 cursor-pointer ${
                  activeActivityTab === tabKey
                    ? 'accent-fill shadow-sm'
                    : 'ink-3 hover:bg-slate-200/50 hover:ink-1'
                }`}
              >
                {tab}
              </button>
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-5">
        <div className="srf-panel rounded-[20px] border hairline p-5 flex items-center justify-between shadow-[0_2px_8px_-2px_rgba(0,0,0,0.05),0_1px_4px_-1px_rgba(0,0,0,0.02)] transition-all hover:shadow-[0_4px_12px_-2px_rgba(0,0,0,0.08)] duration-300">
          <div>
            <p className="text-[11px] font-semibold ink-3 uppercase tracking-widest mb-1.5">Calendarios Totales</p>
            <h3 className="text-3xl font-semibold ink-1 tracking-tight leading-none">{calendarsCount}</h3>
          </div>
          <div className="w-12 h-12 srf-sunken rounded-2xl flex items-center justify-center ink-1 border hairline">
        ...
        <div className="srf-panel rounded-[20px] border hairline p-5 flex items-center justify-between shadow-[0_2px_8px_-2px_rgba(0,0,0,0.05),0_1px_4px_-1px_rgba(0,0,0,0.02)] transition-all hover:shadow-[0_4px_12px_-2px_rgba(0,0,0,0.08)] duration-300">
          <div>
            <p className="text-[11px] font-semibold ink-3 uppercase tracking-widest mb-1.5">Citas Activas</p>
            <div className="flex items-end gap-2.5">
              <h3 className="text-3xl font-semibold ink-1 tracking-tight leading-none">{stats.activeAppointments}</h3>
        ...
        <div className="srf-panel rounded-[20px] border hairline p-5 flex items-center justify-between shadow-[0_2px_8px_-2px_rgba(0,0,0,0.05),0_1px_4px_-1px_rgba(0,0,0,0.02)] transition-all hover:shadow-[0_4px_12px_-2px_rgba(0,0,0,0.08)] duration-300">
          <div>
            <div className="flex items-center gap-1.5 mb-1.5">
               <p className="text-[11px] font-semibold ink-3 uppercase tracking-widest">Ingresos Est.</p>
               <Info className="h-3.5 w-3.5 text-slate-300 cursor-pointer hover:ink-3 transition-colors" />
            </div>
            <div className="flex items-end gap-2.5">
              <h3 className="text-3xl font-semibold ink-1 tracking-tight leading-none">$ {stats.estimatedRevenue}</h3>
